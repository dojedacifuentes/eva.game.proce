...
Los ocho se abren con su gesto real y se miden por dentro:

`npc-zona` · `evento-zona` · `creacion-reemplazo` · `inventario-importar` ·
`reinos-biblioteca` · `civilis-codex` · `civilis-cartas` · `civilis-bestiario`
